...
#ifndef BLOCKNET_XBRIDGE_XTREZARTRANSACTION_H
#define BLOCKNET_XBRIDGE_XTREZARTRANSACTION_H
...
public:
    ...
    /**
     * @brief nTxComment - TX comment
     */
    std::string nTxComment;
...
public:
    ...
    void Serialize(S &s) const
    {
        ...
        ::Serialize(s, txTo.nTxComment);
    }
};

} // namespace xbridge

#endif // BLOCKNET_XBRIDGE_XTREZARTRANSACTION_H
